...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'mobile_backend'),
        'USER': os.environ.get('DATABASE_USER', 'mobile_backend_user'),
        'PASSWORD': os.environ.get('DATABASE_PASS', 'mobile_backend_pass'),
